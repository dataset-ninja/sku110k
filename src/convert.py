...
def convert_and_upload_supervisely_project(
    ...
    dataset_path = "/home/grokhi/rawdata/sku110k/SKU110K_fixed"
    ...
    def create_ann(image_path):
        ...
        bbox_path = os.path.join(anns_path, f"{get_file_name(image_path)}.txt")
    ...
    obj_class = sly.ObjClass("retail item", sly.Rectangle)
    ...
    for ds_name in os.listdir(images_path):
        ...
        cur_images_path = os.path.join(images_path, ds_name)
        anns_path = os.path.join(labels_path, ds_name)

        cur_images_path = glob.glob(cur_images_path + "/*.jpg")

        progress = sly.Progress("Create dataset {}".format(ds_name), len(cur_images_path))

        for img_pathes_batch in sly.batched(cur_images_path, batch_size=batch_size):
